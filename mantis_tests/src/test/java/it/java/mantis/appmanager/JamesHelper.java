...
public class JamesHelper {
  ...
  private void initTelnetSession() {
    ...
    readUntil("Welcome " + login + ". HELP for a list of comands");
  ...
  private List<MailMessage> getAllMail(String username, String password) throws IOException, MessagingException {
    Folder inbox = openInbox(username, password);
    List<MailMessage> messages = Stream.of(inbox.getMessages()).map(m -> toModelMail(m)).collect(Collectors.toList());
    closeFolder(inbox);
    return messages;
  }
